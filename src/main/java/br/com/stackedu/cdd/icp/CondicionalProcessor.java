...
public class CondicionalProcessor extends AbstractProcessor<CtIf> implements ICP {
    ...
    public void process(CtIf element) {
        ...
        /**
         * O +1 aqui requer uma atenção. No while acima, eu conto a presença de um operador binário
         * tipo AND ou OR. Se aparecer esse operador, eu coloco o elemento na lista. Mas perceba que
         * dessa forma eu não terei como armazenar toda a condicional. Por exemplo, se a condicional
         * for (a > b || c < d), no laço eu só contarei a existencia do OR (1, nesse caso), e não da 
         * quantidade de condicionais (2, nesse caso). Logo, o +1 abaixo é uma pog pra minimizar esse
